...
BENCHMARKS_FOLDER =  "/Users/nima/Desktop/njr/june2020_dataset"
...
for benchmark in os.listdir(BENCHMARKS_FOLDER):
  if(benchmark != "urlcb91e63e47_alexGalushka_E97_Assignment3_tgz-pJ8-cscie97_asn3_test_TestDriverJ8"):
    continue
  print(benchmark)
  if (SKIP_COMPLETED):
